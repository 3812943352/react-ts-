 ...
 * @Date: 2024-12-23 11:32:24
 * @LastEditors: wangbo 3812943352@qq.com
 * @LastEditTime: 2024-12-23 11:33:43
 * @FilePath: src/views/commponents/SeamlessScroll/cssSeamlessScroll.tsx
...
class cssSeamlessScroll extends Component {
  ...
  componentDidMount() {
    ...
    document.styleSheets[0].insertRule(
      `@keyframes ${this.state.animation_name}{
      100% {
        z-index: 999;
  ...
  render() {
    return (
      <div>
        ...
        >
          <div ref="slotListRef" style={this.floatStyle}>
            {this.props.children}
          </div>
  ...
  get cssRealBoxWidth() {
    return this.state.realBoxWidth
      ? `${this.state.realBoxWidth}px`
      : "auto";
  }
  ...
  initMove() {
    setTimeout(() => {
      ...
      this.refs.scrollHtml.innerHTML =
        this.refs.slotListRef.innerHTML;
      setTimeout(() => {
        this.setState(
          {
          ...
          function () {
            if (this.props.direction == "left") {
              this.refs.realBoxRef.style.setProperty(
                this.state.var_EndX,
                `${-this.state.realBoxWidth / 2}px`,
              );
            }
            if (this.props.direction == "up") {
              this.refs.realBoxRef.style.setProperty(
                this.state.var_EndY,
                `${-this.state.realBoxHeight / 2}px`,
              );
            }
          },
        );
